                ...
                <v-stepper-items>
                  <v-stepper-content step="1">
                      <v-text-field
                        ...
                        <v-row>
                        <v-col align="end">
                            <v-btn width="150" @click="clearData">
                            Cancel
                            </v-btn>
                        </v-col>
                        <v-col align="start">
                  ...
                  <v-text-field
                        ...
                        <v-textarea outlined label="Tell something about ..." v-model="description" />
                          <form class="py-10" id="upload_form" role="form" enctype="multipart/form-data" >
                                <input type="file" name="file"  id="file" class="form-control">
                          </form>
                    <v-row>
                        <v-col align="end">
                            <v-btn width="150" @click="page=1">
                            Cancel
                            </v-btn>
                        </v-col>
                        <v-col align="start">
  ...
  //  ...mapActions("nomad",["addNomad"]),
   async submitHandler(val){
    ...
    async addNomad(){
      ...
      const response = await this.$axios.post('',form_data,{baseURL:`http://18.218.238.96:5000/api/v1/uploadtest`,'headers':{
